...
ActiveRecord::Schema.define(version: 20191105032143) do
  ...
  create_table "group_articles", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "group_id"
    t.index ["user_id"], name: "index_group_articles_on_user_id"
  end
  ...
  create_table "group_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_article_id"], name: "index_group_comments_on_group_article_id"
